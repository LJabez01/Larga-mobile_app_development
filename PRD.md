...
- commuter-side live vehicle visibility based on the commuter's current route context
...
driver starts live trip tracking or commuter sets a location/reference point ->
...
- The system shall determine the commuter's route context from the current GPS or manual reference point.
